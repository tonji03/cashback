...
public class Cliente {
    ...
    private int codice_id_cliente_presentatore;
    ...
    public Cliente(int id_cliente, String nome, String cognome, Date data_registrazione, int percentuale_cashback, int cap, int cap_mensile, int codice_id_cliente_presentatore, String codice_societa) {
        ...
        this.cap = cap;
        setCapMensile(cap_mensile);
        this.codice_id_cliente_presentatore = codice_id_cliente_presentatore;
    ...
    public int getCodice_id_cliente_presentatore() {
        return codice_id_cliente_presentatore;
    }
    ...
    public void setCodice_id_cliente_presentatore(int codice_id_cliente_presentatore) {
        this.codice_id_cliente_presentatore = codice_id_cliente_presentatore;
    }
